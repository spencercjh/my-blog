...
为了解决 [前文](1-open-source-project-selection.mdx) 中提到的跨地域网络问题，我们引入了一台物理机，上面部署了 bcm-agent 与
...
> 192.168.1.255 都生效。你也可以指定固定的 IP，如 192.168.1.1 或者 192.168.1.1/32，也可以通过逗号分隔多个参数，例如
...
请看下一章，真·Bug 修复：[修复 ChaosBlade 遗留多年的 Bug](./3-bugfix.mdx)！
